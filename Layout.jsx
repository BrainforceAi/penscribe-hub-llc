    ...
    <nav className={`nav ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-inner">
        <a href="#/" className="nav-mark">
          <img src="project/assets/penscribe-logo-on-white.jpg" alt="The PenScribe Hub" />
          <div className="word">
        ...
        <div className="footer-grid">
          <div>
            <div className="footer-mark">
              <img src="project/assets/penscribe-logo-on-blue.jpg" alt="The PenScribe Hub" />
              <div className="word"><div className="t">THE</div><div className="p">PENSCRIBE</div></div>
            </div>
            <p className="footer-bio">Government contracting consultancy. Proposal strategy and writing for service businesses entering federal, state, and municipal procurement. 90% proposal win rate.</p>
          </div>
          <div>
            <h5>Navigate</h5>
            <ul>
