    ...
    <React.Fragment>
      <section className="page-hero">
        <div className="container">
          ...
          <p className="lead">Send a short note about your business and the solicitation you are considering. The first review is free, and I respond within one business day.</p>
        </div>
      </section>
          ...
          <div className="contact-grid">
            <div className="contact-card">
              <form onSubmit={onSubmit}>
                ...
                <div className="field">
                  ...
                  <div className="help">If you have an RFP or RFQ on the table, share it for a free go/no-go review.</div>
                </div>
                <div className="field">
                  ...
                  <select value={form.service} onChange={onChange('service')}>
                    ...
                    <option>RFP & Solicitation Analysis</option>
                ...
                <div className="field">
                  <label>Message</label>
                  <textarea required value={form.message} onChange={onChange('message')} placeholder="Tell me about your business, your past government contracting experience, and what you are trying to win."></textarea>
                </div>
            ...
            <div className="contact-info">
              <dl>
                ...
                <div>
                  <dt>Upwork</dt>
                  <dd><a href="https://www.upwork.com/freelancers/~018a7b32ee0a61e4d0" target="_blank" rel="noopener">Top Rated profile</a><br/><span style={{fontSize:13,color:'var(--fg-3)'}}>For contract engagements through the platform.</span></dd>
                </div>
                <div>
                  <dt>LinkedIn</dt>
                ...
                <div>
                  <dt>Working hours</dt>
                  <dd>Monday — Friday<br/><span style={{fontSize:14,color:'var(--fg-3)'}}>Time-sensitive deadlines (sub-72 hour) considered on a case-by-case basis.</span></dd>
                </div>
              </dl>

              <div className="response-promise">
                <div className="lbl">Response Promise</div>
                <p>I reply to every legitimate inquiry within one business day. If your solicitation deadline is within 5 business days, mark your email <strong>URGENT</strong> in the subject line.</p>
              </div>
            </div>
          </div>
        </div>
